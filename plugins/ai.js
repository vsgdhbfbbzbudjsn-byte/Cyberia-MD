...
malvin({
    ...
    try {
        ...
        if (!response || !response.data || !response.data.result) {
            return reply("❌ No response received from the Drakonis API. Please try again later.");
        }
...
malvin({
    ...
    try {
        ...
        // AI image to attach
        const AI_IMG = 'https://files.catbox.moe/ygfz2e.jpg'; // Replace with a valid image URL
