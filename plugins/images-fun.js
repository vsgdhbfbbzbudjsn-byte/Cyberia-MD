...
async (conn, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }) => {
    try {
        ...
        await conn.sendMessage(from, { image: { url: data.message }, caption: '> *© ᴘᴏᴡᴇʀᴇᴅ ʙʏ Dev Sung ' }, { quoted: mek });
    } catch (e) {
        console.log(e); // ❯❯ Powered by draĸonιѕ-мd 👑
...
async (conn, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }) => {
    try {
        ...
        await conn.sendMessage(from, { image: { url: data[0].url }, caption: 'draĸonιѕ-мd DOWNLOAD CAT 🐈 PICS\n\n> *ᴘᴏᴡᴇʀᴇᴅ ʙʏ draĸonιѕ-мd*' }, { quoted: mek });
    } catch (e) {
        console.log(e);
